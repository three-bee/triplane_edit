...
parser.add_argument(
    "--disable_c_offset", action="store_true", help="Disables c offsets for GOHA method (https://github.com/NVlabs/GOHA/blob/master/docs/dataset_preprocessing.md)."
)
